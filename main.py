...
# characters speed (the number of pixels they move at each frame)
SPEED = 2
...
pacman = Pacman(UP, RIGHT, DOWN, LEFT, SPEED, map)
phantom = Phantom(random.choice(phantoms), map, 11, 17, 13, 16, SPEED)
